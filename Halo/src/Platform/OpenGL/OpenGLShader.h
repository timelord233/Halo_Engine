...
namespace Halo {
	...
	public:
		...
		static SharedPtr<OpenGLShader> CreateFromString(const std::string& source);
	...
	private:
		...
		void ResolveAndSetUniforms(const UniquePtr<OpenGLShaderUniformBufferDeclaration>& decl, Buffer buffer);
	...
	private:
		...
		UniquePtr<OpenGLShaderUniformBufferDeclaration> m_VSMaterialUniformBuffer;
		UniquePtr<OpenGLShaderUniformBufferDeclaration> m_PSMaterialUniformBuffer;
